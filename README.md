...
It's easy, just follow the [contribution guidelines](https://github.com/BaseboxSoftware/ruby-style-guide/blob/master/CONTRIBUTING.md).

# License

Forked from [bbatsov's ruby style guide](https://github.com/bbatsov/ruby-style-guide)
